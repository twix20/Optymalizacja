...
namespace Solver
{
    public class SolverInstance
    {
        ...
        public static SolverInstance Small => new SolverInstance(3, 2, 2, 8)
        {
            ...
            u_0 = 500,
            u_m = 800,
            y_mn_min = new[,] { { 0, 0.2f, 0.3f }, { 0, 0.2f, 0.3f }, { 0, 0.4f, 0.3f }, },
            y_mn_max = new[,] { { 0, 0.7f, 0.9f }, { 0, 0.8f, 0.9f }, { 0, 0.7f, 0.8f }, },
            a_mnsl =
            {
                [0, 1, 1, 5] = 1,
                [0, 2, 2, 6] = 1,
        ...
        public static SolverInstance Big => new SolverInstance(5, 5, 3, 18)
        {
            C_l = new uint[] {0, 1, 2, 4, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000, 1000 },
